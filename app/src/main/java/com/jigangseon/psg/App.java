...
public class App extends Application {
    ...
    private static volatile com.jigangseon.psg.App instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return com.jigangseon.psg.App.getGlobalApplicationContext();
                }
            };
        }
    }

    public static com.jigangseon.psg.App getGlobalApplicationContext() {
        if(instance == null) {
